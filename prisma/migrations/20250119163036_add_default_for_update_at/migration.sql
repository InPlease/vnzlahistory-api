...
INSERT INTO "new_Video" ("bucket_file_name", "createdAt", "description", "id", "isRecommended", "is_reported", "is_verified", "report_team_comments", "report_type", "tags", "thumbnailUrl", "ui_title", "updatedAt", "url", "views") SELECT "bucket_file_name", "createdAt", "description", "id", "isRecommended", "is_reported", "is_verified", "report_team_comments", "report_type", "tags", "thumbnailUrl", "ui_title", "updatedAt", "url", "views" FROM "Video";
DROP TABLE "Video";
